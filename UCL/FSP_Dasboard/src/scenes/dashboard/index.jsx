        ...
        gap="20px">
            ...
            <Box gridColumn= "span 8" gridRow="span 2" backgroundColor={colors.primary[400]}>
                <Box mt="20px" p="0 30px" display="flex" justifyContent="space-between" alignItems="center">
                    ...
                    <Typography variant="h3" fontWeight="500" color= {colors.greenAccent[500]}>£123, 000</Typography>
                </Box>
                <Box height="250px">
                    <LineChart></LineChart>
                </Box>
            ...
            <Box gridColumn= "span 4" gridRow="span 2" backgroundColor={colors.primary[400]}>
                <Box mt="20px" p="0 30px" display="flex" justifyContent="space-between" alignItems="center">
                    <Typography variant="h5" fontWeight="600" color= {colors.grey[100]}>Pie Chart</Typography>
                </Box>
                <Box height="250px">
                    <BarChart></BarChart>
                </Box>
